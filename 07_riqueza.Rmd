...
Com base no número de espécies raras (abundância menor que 10 indivíduos - *default*), o estimador ACE não mostrou tendência de estabilição da curva em uma assíntota e indica a possibilidade de encontrarmos mais sete espécies caso o esforço amostral fosse maior.
...
O valor de Chao2 é máximo quando todas as espécies menos uma são únicas (*uniques*). Neste caso, a riqueza estimada é aproximadamente o dobro da riqueza observada. Colwell & Coddington [-@colwell1994] encontraram que o valor de Chao 2 mostrou ser o estimador menos enviesado para amostras com tamanho pequeno.
