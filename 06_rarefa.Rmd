...
Gotelli & Collwel [-@gotelli2001] descrevem este método e discutem em detalhes as restrições sobre seu uso na ecologia: 
...
Neste exemplo usaremos os dados de espécies de morcegos amostradas em três fragmentos florestais [@brevilgieri2008]: i) Mata Ciliar do Córrego Talhadinho com 12 hectares inserida em uma matriz de pastagem; ii) Mata Ciliar do Córrego dos Tenentes com 10 hectares inserida em uma matriz de cultivo de cana-de-açucar e pastagem; e iii) Fazenda Experimental de Pindorama com 128 hectares inserida uma matriz de cana-de-açúcar e pastagem. 
...
# q refere-se a família *Hill-numbers* (Hill 1973) onde 0 = riqueza de espécies, 1 =  diversidade de Shannon, e 2 = diversidade de Simpson. Veja Capítulo 11 para detalhes.
...
#### Exemplo prático 3 - Generalized Least Squares (GLS)
